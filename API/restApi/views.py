...
#ModelViewSet. Here we don't even need to specify mixins. Basic functionalities like POST, GET, PUT and DELETE are included.
...
# In GenericViewset, mixins automatically do their work.
...
# class-based API_View and Using GenericAPIView and Mixins
...
# methods of class-based api-view
